                  ...
                  >
                    ...
                    >
                      {clothingStylesData.map((style) => (
                        <Radio
                          key={style.value}
                          className={`w-full h-[40px] border-none rounded-none ${selectedStyle && selectedStyle !== style.value ? 'faded' : ''}`}
                          value={style.value}
                          style={{ backgroundColor: `${style.color}8D` }}
                        >
                          <div className="flex">
                            <p className="capitalize">{style.name}</p>
                          </div>
                        </Radio>
                      ))}
                    </Radio.Group>
