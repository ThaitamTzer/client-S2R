...
import { Image, Tooltip, Button, Popconfirm } from 'antd'
...
export const Requester = ({ exchange }: { exchange: ExchangeType }) => {
    ...
    <>
      <div className="flex flex-col gap-5">
        ...
        <div className="flex flex-row justify-start items-start gap-2">
          ...
          <div className="flex flex-col gap-2 text-base">
            ...
            <div className="flex flex-row items-center gap-3">
              ...
              <p className="text-base">{truncateText(exchange?.note, 20)}</p>
            </div>
          </div>
        </div>
        {/* Status */}
        ...
        {exchange.allExchangeStatus !== 'pending' && (
          <div className="flex flex-col justify-start items-start gap-4 max-w-[900px]">
            <Stepper
              active={active}
            ...
            >
                  ...
                  <div className="container mx-auto p-3 flex flex-col justify-start gap-2">
                    ...
                    <div className="flex items-center gap-3 mt-2">
                      ...
                      <Button
                        variant="solid"
                        color="primary"
                        onClick={() => handleUpdateStatus(exchange._id, 'delivered')}
                        loading={isLoading}
                      >
                        Cập nhật
                      </Button>
              ...
              >
                <div className="w-full h-full bg-white shadow-sm rounded-sm">
                  <div className="container mx-auto p-3 flex justify-start items-center gap-2">
              ...
              {exchange?.requestStatus.exchangeStatus === 'canceled' && (
                <Stepper.Step label="Đã Hủy" title="Đã hủy">
                  <div className="w-full h-full bg-white shadow-sm rounded-sm">
                    <div className="container mx-auto p-3 flex flex-col justify-start gap-2">
                      <p className="text-base font-medium">Đơn hàng đã bị hủy</p>
                    </div>
                  </div>
                </Stepper.Step>
              )}
